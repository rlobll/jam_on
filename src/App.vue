<template>
  <div id="app">
    <div class="terms" v-if="modalOpen">
      <div class="terms_inner">
        <div class="terms_header">
          <h4 class="terms_title">이용약관</h4>
          <button class="terms_btn" @click="closeModal">&times;</button>
        </div>
        ...
        <div class="terms_body">
          ...
          보호를 위하여 회원이 선정한 문자와 숫자의 조합을 말합니다.<br />
          ...
          약관과 운영정책이 중첩될 경우 운영정책이 우선 적용됩니다.<br />
          <br />
          제4조 이용계약 체결<br />
          <br />
          ① 이용계약은 회원으로 등록하여 사이트를 이용하려는 자의 본 약관 내용에
          대한 동의와 가입신청에 대하여 운영자의 이용승낙으로 성립합니다.<br />
          ...
          있지 않으며 이와 관련된 부분은 사이트의 개인정보처리방침을
          따릅니다.<br />
          ...
          자료를 열람 및 해당 자료를 관련 기관에 제출할 수 있습니다.<br />
          <br />
          제7조 운영자의 의무<br />
          <br />
          ...
          해지와 별개로 사이트에 대한 이용계약 해지는 별도로 하셔야 합니다.<br />
          ...
          삭제하고 이를 등록한 회원에게 주의를 주어야 합니다.<br />
          한편, 이용회원이 올린 게시물에 대해서는 게시자 본인에게 책임이 있으니
          회원 스스로 본 이용약관에서 위배되는 게시물은 게재해서는 안 됩니다.<br />
          ② 정보통신윤리위원회 등 공공기관의 시정요구가 있는 경우 운영자는
          회원의 사전동의 없이 게시물을 삭제하거나 이동 할 수 있습니다.<br />
          ...
          없는 불가항력적 사유로 인한 회원의 손해에 대하여 책임지지 않습니다.<br />
          <br />
          부칙<br />
          <br />
    ...
    <div class="top_ad">
      <p>
        <a href="https://zam-on.co.kr/shop_view/?idx=90">
          ★ [마지막재고] 탄소매트 1+1 특가 바로가기 ★
        </a>
      </p>
    </div>
    ...
    <div class="jamon_logo">
      <router-link to="/">
        <img src="./assets/jam_on_logo.png" alt="잠온 로고" />
      </router-link>
    </div>
    ...
    <nav class="menu">
      <div>
        <router-link to="/bedding">차렵이불</router-link>
        <router-link to="/winter">겨울가전</router-link>
        <router-link to="/summer">여름가전</router-link>
      </div>
    </nav>
    ...
    <div class="footer">
      ...
      <div class="ft_bottom">
        <button type="button" @click="openModal">이용약관</button>
        ...
        <div class="company_sns">
          <div class="company">
            ...
            <div class="info">
              ...
              <p>대표자 : 김준화</p>
              <address>
                주소 : 경기도 남양주시 순화궁로 249, M동 631,632호
              </address>
              <p>사업자등록번호 : 106-86-86033</p>
              <p>통신판매업신고번호 : 제2021-별내-0723호</p>
            </div>
          </div>
          <div class="sns">
            <a
              href="https://www.instagram.com/zamon_original/?hl=ko"
              target="_blank"
            >
              <img src="./assets/icon_sns_insta.png" alt="잠온 인스타그램" />
            </a>
          </div>
        </div>

        <div class="copy">
          <p>COPYRIGHT (주)서경디지털 ALL RIGHTS RESERVED.</p>
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <div class="togo_top">
        <a href="#"><img src="./assets/togo_top.png" alt="" /></a>
      </div>
    </div>
  </div>
</template>
